...
<h3 style="text-align:left; font-family:Tale;">
    Current payments (average: <b>$<?=$average[0]['amount']?></b> out of total <b><?=$num_of_payments?></b> payments)</h3>
<h4>Maximum payment amount is: <b><?=$maxpayment[0]['amount']?></b> in category <?=$maxpayment[0]['name']?>) </h4>
